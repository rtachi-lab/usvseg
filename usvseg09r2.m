function varargout = usvseg09r2(action)
% usvseg09r2
%
...
set(hfig,'KeyPressFcn','usvseg09r2(get(gcf,''CurrentCharacter''));');
...
% callbacks
set(hpush_open,'callback','usvseg09r2(''open'');');
set(hpush_flat,'callback','usvseg09r2(''flat'');');
set(hpush_thrs,'callback','usvseg09r2(''thrs'');');
set(hpush_dtct,'callback','usvseg09r2(''dtct'');');
set(hpush_save,'callback','usvseg09r2(''save'');');
set(hpush_sgmt,'callback','usvseg09r2(''sgmt'');');
set(hpush_play,'callback','usvseg09r2(''play'');');
set(hpush_swav,'callback','usvseg09r2(''swav'');');
set(hpush_long,'callback','usvseg09r2(''long'');');
set(hpush_fldr,'callback','usvseg09r2(''fldr'');');
% text set
